...
--Select p.Name, p.Description, p.Image, c.Name as Cor, m.Name as Tipo, s.SizeID as Tamanho from product AS p
...
--select Trainings.Title, Trainings.Description, Trainings.TotalViews, Trainings.StoreViews, Trainings.Video, Trainings.UniqueUserViews, Type.Name as Tipo
--from Type
